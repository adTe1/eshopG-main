...
// Διαγραφή User
export const USER_DELETE_REQUEST = 'PRODUCT_DELETE_REQUEST';
export const USER_DELETE_SUCCESS = 'PRODUCT_DELETE_SUCCESS';
export const USER_DELETE_FAIL = 'PRODUCT_DELETE_FAIL';